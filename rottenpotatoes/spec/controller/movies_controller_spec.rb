require 'rails_helper'
 describe MoviesController, :type => :controller do
    ...
    before(:each) do
        @movie_1 = Movie.create(title: "title_1",rating: "G", description:"dummy", director: "director",release_date: 123123)
    end
    ...
    describe "#new" do
        before(:each) do
            @movies_params = {title: "title_1",rating: "G",director: "director",release_date: 123123}
        end
    ...
    describe "#update" do
        before(:each) do
            ...
            @movie_params= {:title => "title_1", :rating => "PG", :director => "dummy",:release_date => 1111111}
        end
    ...
    describe "#destroy" do
        before(:each) do
            @movie_2 = Movie.create(title: "title_1",rating: "G",director: "director",release_date: 123123)
        end
        it "destroy movie" do
    ...
    describe "#create" do
        before(:all) do
            @movie_params = {title: "title_1",rating: "G", description: "dummy", director: "director",release_date: 123123}
        end
    ...
    describe "samedirector" do
        before(:each) do
            @movie_2 = Movie.create(:id => "1111", title: "title_2", director: "director1")
        end

        it "return sad path if no director" do
            @movie_4 = Movie.create(:id => "2222", title: "title_4", director: nil)
            get :samedirector,  id: @movie_4[:id]
            expect(response).to redirect_to(movies_path)
        end

        it "director exists" do
            @movie_3 = Movie.create(:id => "3333", title: "title_3", director: "director1")
